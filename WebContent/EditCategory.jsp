  	...
  	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="row">
					<form id="editUserOptions" method="GET" action="editCategory">
						<div class="editCategoryDiv">
							<div class="nameOfCategory">
								<label id="labels" for="nameOfCategory" for="nameOfCategory">име</label>
								<input type="text" name="nameOfCategory" id="name" value="<%=request.getParameter("nameOfCategory")%>"/>
							</div>
							...
							<div class="descriptionOfCategory">
								...
								<textarea rows="4" cols="23" name="descriptionOfCategory" id="description"><%=request.getParameter("descriptionOfCategory")%></textarea>	
							</div>
							<input type="hidden" name="childCategoryId" value="<%=request.getParameter("childCategoryId")%>" />
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
				<jsp:include page="menu.jsp">
					...
					<jsp:param name="activeMenuItem" value="editCategory"/>
				</jsp:include>
			</div><!--/span-->
		</div>
