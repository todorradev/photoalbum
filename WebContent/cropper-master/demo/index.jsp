...
<head>
  ...
  <title>PhotoAlbum - Crop Image</title>
...
<% 
	...
	String pictureId = (String)request.getParameter("pictureId");
	String imagePath = "/PhotoAlbum/dbPictures/" + userId + "/" + categoryId + "/" + pictureId + ".jpg";
%>
  <!-- header -->
